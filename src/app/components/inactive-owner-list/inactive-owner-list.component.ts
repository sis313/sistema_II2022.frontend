...
@Component({
  selector: 'app-inactive-owner-list',
  templateUrl: './inactive-owner-list.component.html',
  styleUrls: ['./inactive-owner-list.component.css']
})
export class InactiveOwnerListComponent implements OnInit {
  active: user[] = [];
  ownerList: user[] = [];
